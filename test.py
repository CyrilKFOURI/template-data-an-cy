...
HARDCODED_DATA_PATH = ""
COUNTRIES_TO_READ = ["ITALY", "SPAIN", "BELGIUM", "FRANCE", "GERMANY", "LUXEMBOURG", "NETHERLANDS", "UNITED KINGDOM"]
START_YYYYMM = "202001"
END_YYYYMM = "203112"
...
def kpi8_production_ytd(df: pd.DataFrame, country: str, year: int | str, asset_status: str, metric_mode: str) -> tuple[pd.DataFrame, str, str, str]:
    ...
    subset = subset.copy()
    start_dates = pd.to_datetime(subset.get("CONTRACT_START_DATE"), errors="coerce")
