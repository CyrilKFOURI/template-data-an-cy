...
def prepare_data_set(df: pd.DataFrame) -> pd.DataFrame:
    ...
    # 1. Standard Datetime Conversions
    ...
    # 2. Extract Year/Month for internal logic
    df["YEAR"] = df["COB_DATE"].dt.year
    df["MONTH"] = df["COB_DATE"].dt.month

    # 3. Fuel Mappings & Power Categories
    fuel_mapping = {
