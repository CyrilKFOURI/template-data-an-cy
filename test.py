...
def update_view6_kpi13(_refresh_clicks: int, status_value: str, reg_type: str, variable: str, period_mode: str, top_n: str):
    print(f"DEBUG: update_view6_kpi13 triggered with status={status_value}, reg_type={reg_type}, var={variable}, period={period_mode}, top_n={top_n}")
    if has_missing_filters(status_value, reg_type, variable):
        print("DEBUG: Missing filters detected.")
        empty_fig = go.Figure()
        empty_fig.update_layout(title="KPI 13 - Sélectionnez les filtres puis cliquez sur Reload")
        return empty_fig, html.Div("Sélectionnez les filtres puis cliquez sur Reload.", className="small-note")

    if market_df.empty:
        print("DEBUG: market_df is empty.")
        empty_fig = go.Figure()
    ...
    print(f"DEBUG: Calling kpi_top_brand_vs_market with portfolio_var={var_portfolio}, market_var={var_market}")
    try:
        ...
        print(f"DEBUG: kpi13 result shape: {kpi13.shape}")
    except Exception as e:
        print(f"DEBUG: Error in kpi_top_brand_vs_market: {e}")
        import traceback
        traceback.print_exc()
        raise e
    ...
    if kpi13.empty:
        print("DEBUG: kpi13 is empty, returning empty fig and message.")
