...
def view1_layout() -> html.Div:
    return html.Div(
        [
            html.Div(
                [
                    html.Img(src=LOGO_PATH.resolve().as_uri(), style={"width": "72px", "height": "72px", "objectFit": "contain", "borderRadius": "0px", "background": "#ffffff", "boxShadow": "0 8px 18px rgba(0,0,0,0.12)", "marginRight": "16px"}),
                    html.Div(
                        [
