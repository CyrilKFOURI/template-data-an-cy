...
def get_view1_metrics_cached(
    ...
    return {
        "kpi1": kpi_lease_under_25(df, kpi1_country, kpi1_year, month1, kpi_common_bike_or_car, date_mode),
        "kpi2": kpi_lease_25_30(df, kpi2_country, kpi2_year, month2, kpi_common_bike_or_car, date_mode),
        "diesel_non": kpi_diesel_non_diesel(df, kpi3_country, kpi3_year, month3, kpi_common_bike_or_car, date_mode),
        "hybrid": kpi_hybrid_share(df, kpi4_country, kpi4_year, month4, kpi_common_bike_or_car, date_mode),
        "ev": kpi_ev_share(df, kpi5_country, kpi5_year, month5, kpi_common_bike_or_car, date_mode),
        "pv_lcv": kpi_pv_lcv(df, kpi6_country, kpi6_year, month6, kpi_common_bike_or_car, date_mode),
        "month3": month3,
        "month4": month4,
        "month5": month5,
        "month6": month6,
        "month1": month1,
        "month2": month2,
        "kpi1_volume": kpi_selected_volume(df, kpi1_country, kpi1_year, month1, status="IN FLEET", bike_or_car=kpi_common_bike_or_car, date_mode=date_mode),
        "kpi2_volume": kpi_selected_volume(df, kpi2_country, kpi2_year, month2, status="IN FLEET", bike_or_car=kpi_common_bike_or_car, date_mode=date_mode),
        "kpi3_volume": kpi_selected_volume(df, kpi3_country, kpi3_year, month3, status="IN FLEET", bike_or_car=kpi_common_bike_or_car, date_mode=date_mode),
        "kpi4_volume": kpi_selected_volume(df, kpi4_country, kpi4_year, month4, status="IN FLEET", bike_or_car=kpi_common_bike_or_car, date_mode=date_mode),
        "kpi5_volume": kpi_selected_volume(df, kpi5_country, kpi5_year, month5, status="IN FLEET", bike_or_car=kpi_common_bike_or_car, date_mode=date_mode),
        "kpi6_volume": kpi_selected_volume(df, kpi6_country, kpi6_year, month6, status="IN FLEET", bike_or_car=kpi_common_bike_or_car, date_mode=date_mode),
    }
...
def build_view1_download_report(
    ...
    kpi1_val = kpi_lease_under_25(df, kpi1_country, kpi1_year, kpi1_month, kpi_common_bike_or_car, date_mode)
    kpi2_val = kpi_lease_25_30(df, kpi2_country, kpi2_year, kpi2_month, kpi_common_bike_or_car, date_mode)
    diesel_non = kpi_diesel_non_diesel(df, kpi3_country, kpi3_year, month3, kpi_common_bike_or_car, date_mode)
    hybrid_val = kpi_hybrid_share(df, kpi4_country, kpi4_year, month4, kpi_common_bike_or_car, date_mode)
    ev_val = kpi_ev_share(df, kpi5_country, kpi5_year, month5, kpi_common_bike_or_car, date_mode)
    pv_lcv_val = kpi_pv_lcv(df, kpi6_country, kpi6_year, month6, kpi_common_bike_or_car, date_mode)
