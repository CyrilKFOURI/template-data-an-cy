    ...
    for brand in df2["_BRAND_CLEAN"].unique():
        ...
        for idx in df1_brand_idx:
            ...
            for _, row2 in df2_brand.iterrows():
                ...
                numbers_1 = set(
                    re.findall(r"\d+", model_1)
                )

                numbers_2 = set(
                    re.findall(r"\d+", model_2)
                )
...
def compare_model_matching(
    ...
    def update(change):
        ...
        for _, row in sub.iterrows():
            ...
            numbers_1 = set(
                re.findall(r"\d+", model_1_clean)
            )

            numbers_2 = set(
                re.findall(r"\d+", model_2_clean)
            )

            is_match = (
                (
                    model_1_clean == model_2_clean
                    or (
                        model_2_clean in model_1_clean
                        and model_2_clean != ""
                    )
                )
                and (
