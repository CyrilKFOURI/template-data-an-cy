...
<head>
    ...
    <style>
        ...
        body {{ font-family: Arial, Helvetica, sans-serif; margin: 28px; color: var(--ink); background: linear-gradient(180deg,
        .page {{ max-width: 1240px; margin: 0 auto; background:
        h1, h2, h3 {{ color:
        ...
        .report-logo {{ width: 72px; height: 72px; object-fit: contain; border-radius: 0; background:
        ...
        .kpi-result-value {{ font-size: 28px; font-weight: 800; color:
        .kpi-result-value .kpi-value-text {{ color:
    ...
    for card in cards:
        ...
        if bool(card.get("show_legend", False)):
            legend_html = (
                ...
                "<span class=\"kpi-legend-item\"><span class=\"kpi-legend-chip\" style=\"background:
                "<span class=\"kpi-legend-item\"><span class=\"kpi-legend-chip\" style=\"background:
                "<span class=\"kpi-legend-item\"><span class=\"kpi-legend-chip\" style=\"background:
                "</div>"
            )
