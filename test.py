...
def load_dataset() -> pd.DataFrame:
    ...
    # Prefer precomputed enriched folder if available so MARKET_MODEL and other derived fields are present
    enriched_folder = DEFAULT_DATA_FOLDER.parent / "data_market_enriched"
    if enriched_folder.exists() and any(enriched_folder.rglob("*.parquet")):
        data_folder = enriched_folder
